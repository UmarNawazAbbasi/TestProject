...
import kotlinx.android.synthetic.main.fragment_detial.*
...
class DetialFragment : Fragment() {
    ...
    private var photUrl:String? = null
    ...
    override fun onCreateView(
        ...
        photUrl=getArguments()?.getString("photoUrl")!!;
